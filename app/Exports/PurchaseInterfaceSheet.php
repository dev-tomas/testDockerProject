...
class PurchaseInterfaceSheet implements FromView, WithHeadings,ShouldAutoSize, WithEvents, WithTitle
{
    public $book;
    public $type;
    ...
    public function view(): View
    {
        ...
        if ($this->type == 1) {
            return view('accountancy.purchase.interfaz-xls', $data);
        } else {
            return view('accountancy.purchase.v2136.interfaz-xls', $data);
        }
