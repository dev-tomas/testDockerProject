...
class ReceiptsFeesHeadSheet implements FromView, WithHeadings,ShouldAutoSize, WithEvents, WithTitle
{
    public $data;
    ...
    {
        return view('accountancy.receipt-fees.excel.head', ['data' => $this->data]);
    }
