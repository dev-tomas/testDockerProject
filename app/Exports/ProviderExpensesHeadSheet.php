...
class ProviderExpensesHeadSheet implements FromView, WithHeadings,ShouldAutoSize, WithEvents, WithTitle
{
    public $sales;
    public $movements;
    public $voucher;
    ...
    {
        return view('accountancy.purchasePayment.interfaz-xls-head', [
            'sales' => $this->sales,
            'sd' => $this->sd,
