...
class ReportIncomeExport implements FromView, ShouldAutoSize, WithEvents, WithStyles
{
    public $data;
    ...
    {
        return view('commercial.reports.income.excel', ['data' => $this->data]);
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class=> function(AfterSheet $event) {
                ...
                $event->sheet->getStyle('A2:F2')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setRGB('92D050');
                $event->sheet->getStyle('G2:L2')->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setRGB('595959');
...
//                $event->sheet->getDelegate()->getStyle()
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle("A3:L{$totalRows}")->applyFromArray($estilo);
