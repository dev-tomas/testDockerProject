                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="type" id="type" class="form-control">
                                                    @foreach($operations_type as $operation_type)
                                                        @if($typeModal)
                                                            @if($operation_type->id == 1 || $operation_type->id == 2)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-2 quantity">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="1" class="form-control" id="quantity" name="quantity" readonly required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-lg-2">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-3" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" class="form-control" id="higher_price" name="higher_price">
                                            </div>
                                        </div>
...
<script>
    ...
    // $('#mdlProduct').click(function () {
    //     $('#typeProductModal').modal('hide');
    //     $('#mdl_add_product').modal('show');
    // })
    // $('#mdlProduct2').click(function () {
    //     $('#typeProductModal').modal('hide');
    //     $('#mdl_add_product2').modal('show');
    // })
