...
@section('content')
    <form method="post" role="form" data-toggle="validator" id="frm_quotation">
        ...
        <input type="hidden" value="{{ $quotation->id }}" name="idQuotation">
        <div class="row">
            <div class="col-12">
                        ...
                        <div class="row">
                                    ...
                                    <div class="input-group">
                                        <select name="customer" id="customer" class="form-control" style="width: 80%;" required>
                                            @foreach($customers as $c)
                                                <option value="{{$c->id}}" {{ $c->id == $quotation->customer_id ? 'selected' : '' }} c-email="{{$c->email}}">
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input value="{{ date('d-m-Y', strtotime($quotation->date)) }}" type="text" class="form-control datepicker" name="date" id="date" autocomplete="off" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-md-1">
                                ...
                                <select name="coin" id="coin" class="form-control" required>
                                    @if($coins->count() > 0)
                                        @foreach($coins as $c)
                                            <option value="{{$c->id}}" {{ $quotation->coin_id == $c->id ? 'selected' : '' }}>{{$c->symbol}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control datepicker" name="expiration" id="expiration" autocomplete="off" required value="{{ date('d-m-Y', strtotime($quotation->expiration)) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="condition" id="condition" class="form-control">
                                        <option value="EFECTIVO" {{ $quotation->condition == 'EFECTIVO' ? 'selected' : '' }} data-days="0">EFECTIVO</option>
                                        <option value="CREDITO" {{ $quotation->condition == 'CREDITO' ? 'selected' : '' }}>CREDITO</option>
                                        <option value="TARJETA DE CREDITO" {{ $quotation->condition == 'TARJETA DE CREDITO' ? 'selected' : '' }} data-days="0">TARJETA DE CREDITO</option>
                                        <option value="TARJETA DE DEBITO" {{ $quotation->condition == 'TARJETA DE DEBITO' ? 'selected' : '' }} data-days="0">TARJETA DE DEBITO</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-1">
                            ...
                            <div class="col-12 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control" name="order" id="order" value="{{ $quotation->order }}" />
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tbody>
                                                @foreach ($details as $detail)
                                                    <tr>
                                                                ...
                                                                <select style="width: 80%;" class="form-control select_2 c_product" id="c_product" name="cd_product[]" required>
                                                                    ...
                                                                    @if($products->count() > 0)
                                                                        @foreach($products as $p)
                                                                            <option value="{{$p->id}}" p-it="{{ $p->priceIncludeRC }}" p-taxbase="{{ $p->taxbase }}" 
                                                                                    p-tax="{{ $p->tax }}" p-type_product="{{$p->type_product}}" p-stock="{{$p->stock}}" 
                                                                                    p-igv-type="{{ $p->type_igv_id }}" p-price="{{$p->price}}" p-otype='{{ $p->operation_type }}' 
                                                                                    p-exonerated="{{ $p->exonerated }}" {{ $detail->product_id == $p->id ? 'selected' : '' }}>{{ $p->internalcode }} - {{$p->description}}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control c_detail" name="cd_detail[]" value="{{ $detail->detail }}" />
                                                        </td>
                                                        <td>
                                                            <input type="number" class="form-control c_quantity" step="0.01" min="1" name="cd_quantity[]" value="{{ $detail->unity }}" max="99999"/>
                                                        </td>
                                                        <td>
                                                            <select name="cd_price[]" class="form-control c_price">
                                                                @foreach ($detail->product->product_price_list as $price)
                                                                    <option value="{{ $price->price }}" {{ $detail->price == $price->price ? 'selected' : '' }}>{{ $price->price_list->description }} - {{ $price->price }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control c_subtotal" name="cd_subtotal[]" value="{{ $detail->subtotal }}" readonly/>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control c_total" name="cd_total[]" value="{{ $detail->total }}" readonly/>
                                                        </td>
                                                        <td>
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="t_detraction" id="t_detraction" class="form-control" value="{{ $quotation->detraction == 1 ? 'Operación sujeta al Sistema de Pago de Obligaciones Tributarias:' : '' }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <label></label>
                                        <label class="ckbox">
                                            <input type="checkbox" value="1" name="detraction" id="detraction" {{ $quotation->detraction == 1 ? 'checked' : '' }}><span>¿Detracción?</span>
                                        </label>
                                    </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <input name="c_exonerated" id="exonerated" type="text" class="form-control" readonly value="{{ $quotation->exonerated }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 text-right">
                                    ...
                                    <div class="col-6">
                                        <input name="c_unaffected" id="c_unaffected" type="text" class="form-control" readonly value="{{ $quotation->unaffected }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 text-right">
                                    ...
                                    <div class="col-6">
                                        <input name="c_taxed" id="c_taxed" type="text" class="form-control" readonly value="{{ $quotation->taxed }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 text-right">
                                    ...
                                    <div class="col-6 text-right">
                                        <input name="c_igv" id="c_igv" type="text" class="form-control" readonly value="{{ $quotation->igv }}">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-6 text-right">
                                    ...
                                    <div class="col-6 text-right">
                                        <input name="c_free" id="c_free" type="text" class="form-control" readonly value="{{ $quotation->free }}">
                                    </div>
                                </div>
                                @if ($clientInfo->consumption_tax_plastic_bags == 1)
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-right">
                                            <input name="c_t" id="c_t" type="text" class="form-control" value="{{ $quotation->icbper }}" readonly>
                                        </div>
                                    </div>
                                @else
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        <input name="recharge" id="recharge" type="text" class="form-control" value="{{ $quotation->recharge }}" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        <input name="c_total" id="c_total" type="text" class="form-control" readonly value="{{ $quotation->total }}">
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="1" min="1" class="form-control" value="{{ $quotation->credit_frecuency }}" name="dueFrecuency" id="dueFrecuency">
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    <label>Número de Cuota</label>
                                    <input type="text" class="form-control" name="numberDues" value="{{ $quotation->credit_time }}" id="numberDues">
                                </div>
                            </div>
                            ...
                            @foreach ($quotation->payments as $payment)
                                <div class="row">
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label>Fecha</label>
                                            <input type="text" class="form-control datepick" name="payment_date[]" value="{{ date('d-m-Y', strtotime($payment->date)) }}">
                                        </div>
                                    </div>
                                    <div class="col-5">
                                        <div class="form-group">
                                            <label>Monto</label>
                                            <input type="number" step="0.01" min="1" class="form-control" value="{{ $payment->mount }}" name="payment_amount[]">
                                        </div>
                                    </div>
                                    <div class="col-2">
                        ...
                        $.confirm({
                            ...
                            buttons: {
                                Confirmar: {
                                    ...
                                    action: function(){
                                        $.ajax({
                                            url: '/commercial.quotations.edit',
                                            type: 'post',
                                            data: data + '&_token=' + '{{ csrf_token() }}',
                                            dataType: 'json',
                                            beforeSend: function() {
