                ...
                <div class="card-header color-gray">
                    <div class="row">
                        <div class="col-12 col-md-12 text-center">
                            <h3 class="card-title">KARDEX FISICO</h3>
                        </div>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover mg-b-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center" colspan="1" class="text-center entries" width="100px">INGRESO</th>
                                        <th align="center" colspan="1" class="text-center exit" width="100px">SALIDA</th>
                                        <th align="center" colspan="1" class="text-center" width="100px">SALDO</th>
                                    </tr>
                                   <!-- <tr>
                                        <th colspan="5"></th>
...
@section('script_admin')
    <script>
        ...
        $('#kExcel').click(function(e) {
            e.preventDefault();
            let data = $('#form_kardex').serialize(); 
            window.open('/kardex-fisic/generate/excel? ' + data, '_blank');
        });
        $('#kPDF').click(function(e) {
            e.preventDefault();
            let data = $('#form_kardex').serialize(); 
            window.open('/kardex-fisic/generate/pdf? ' + data, '_blank');
        });
        $('.select_2').select2();
