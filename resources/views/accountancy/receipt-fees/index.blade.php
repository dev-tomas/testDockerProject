                ...
                <div class="card-header color-gray">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h3 class="card-title">CONTABILIDAD RECIBOS POR HONORARIOS</h3>
                        </div>
                    </div>
                    <div class="row">
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="movement" name="movement" class="form-control" placeholder="Ingresar Movimiento">
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
...
@section('script_admin')
    <script>
        $('#formPreview').submit(function(e) {
            ...
            window.open('/accounting/receips-fees/generate? ' + correlatives, '_blank');
