    ...
    <tbody>
        @foreach ($sales as $sale)
            ...
            <tr>
                ...
                @if ($sale->condition_payment == 'EFECTIVO' || $sale->condition_payment == 'DEPOSITO EN CUENTA' || $sale->condition_payment == 'TARJETA DE CREDITO' || $sale->condition_payment == 'TARJETA DE DEBITO')
                    <td>1212101</td>
                @else
                    @if($sale->condition_payment == 'DEVOLUCION')
                        <td>1200001</td>
                    @else
                        <td>1212102</td>
                    @endif
        ...
        @foreach ($creditnotes as $credit)
            ...
            <tr>
                ...
                @if ($credit->condition_payment == 'EFECTIVO' || $credit->condition_payment == 'DEPOSITO EN CUENTA' || $credit->condition_payment == 'TARJETA DE CREDITO' || $credit->condition_payment == 'TARJETA DE DEBITO')
                    <td>1212101</td>
                @else
                    @if($credit->condition_payment == 'DEVOLUCION')
                        <td>1200001</td>
                    @else
                        <td>1212102</td>
                    @endif
