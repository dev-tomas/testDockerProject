<table>
    <tbody>
        <tr>
            <td><strong>FORMATO 13.1: "REGISTRO DE INVENTARIO PERMANENTE VALORIZADO - DETALLE DEL INVENTARIO VALORIZADO"</strong></td>
        </tr>
        <tr>
            <td></td>
        </tr>
        ...
        <tr><td><strong>APELLIDOS Y NOMBRES, DENOMINACIÓN O RAZÓN SOCIAL: </strong> &nbsp; {{ auth()->user()->headquarter->client->trade_name }}</td></tr>
        <tr><td><strong>ESTABLECIMIENTO (1): </strong> &nbsp; {{ $warehouse->headquarter->address }}</td></tr>
        ...
        <tr><td><strong>CÓDIGO DE LA UNIDAD DE MEDIDA (TABLA 6): </strong> &nbsp; {{ $product->ot->code }}</td></tr>
        ...
        <tr>
            ...
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;" align="center" colspan="3" class="text-center">ENTRADAS</td>
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;" align="center" colspan="3" class="text-center">SALIDA</td>
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;" align="center" colspan="3" class="text-center">SALDO</td>
        </tr>
        <tr>
            ...
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">CANTIDAD</td>
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">COSTO UNIT.</td>
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">COSTO TOTAL</td>
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">CANTIDAD</td>
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">COSTO UNIT.</td>
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">COSTO TOTAL</td>
            <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">CANTIDAD</td>
        ...
        @foreach ($kardexs as $item)
            <tr>
                ...
                <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">{{ $item['cost_entry'] }}</td>
                <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">{{ $item['entry_cost'] }}</td>
                ...
                <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">{{ $item['cost_output'] }}</td>
                <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">{{ $item['output_cost'] }}</td>
                ...
                <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">{{ $item['cost_balance'] }}</td>
                <td style="border: 1px solid #000000;border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #000000; text-align: center; line-height: 15;">{{ $item['balance_cost'] }}</td>
            </tr>
        @endforeach
    </tbody>
</table>