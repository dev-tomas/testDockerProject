                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                <div class="form-group text-center align-items-center">
                                    ...
                                    @can('kardex.addmovement')
                                        <button type="button" id="addMovement" class="btn btn-primary-custom mt-4"><i class="fa fa-plus"></i> Movimiento</button>
                                    @endcan
                            ...
                            <table class="table table-bordered table-hover mg-b-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th align="center" class="text-center entries" width="100px">INGRESO</th>
                                        <th align="center" class="text-center exit" width="100px">SALIDA</th>
                                        <th align="center" class="text-center" width="100px">SALDO</th>
                                    </tr>
                                </thead>
...
toastr.error('Ocurrio un error');
        ...
        $('#kExcel').click(function(e) {
            e.preventDefault();
            let data = $('#form_kardex').serialize(); 
            window.open('/kardex/generate/excel? ' + data, '_blank');
        });
        $('#kPDF').click(function(e) {
            e.preventDefault();
            let data = $('#form_kardex').serialize(); 
            window.open('/kardex/generate/pdf? ' + data, '_blank');
            // window.location = '/kardex/generate/pdf?' + data;
        });
        $('.select_2').select2();
