                    ...
                    <form id="frm_shopping" method="post" class="form-horizontal" role="form" data-toggle="validator">
                        <div class="row">
                                        ...
                                        <select name="provider" id="provider" class="form-control" style="width: 80%;" required>
                                            @if($providers->count() > 0)
                                                @foreach($providers as $c)
                                                    <option value="{{$c->id}}" data-document="{{ $c->document }}" c-email="{{$c->email}}">
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    <label>Fecha</label>
                                    <input class="form-control date-picker datepicker" value="{{ $date }}" id="fecha" name="fecha" type="text" data-date-format="yyyy-mm-dd" required autocomplete="off">
                                </div>
                            </div>
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    <label>Serie</label>
                                    <input type="text" maxlength="5" name="shoppingSerie" id="shoppingSerie" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    <label>Número</label>
                                    <input type="number" step="1" name="shoppingCorrelative" id="shoppingCorrelative" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    <br>
                                    <label><input type="checkbox" id="apply_retention" {{ $shopping != null && $shopping->has_retention ? 'checked' : '' }} name="has_retention"> Aplica Retención 8%</label>
                                </div>
                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            <select style="width: 80%;" class="form-control select_2 producto" id="producto" name="producto[]" required>
                                                                ...
                                                                @if($product->count() > 0)
                                                                    @foreach($product as $p)
                                                                        <option value="{{$p->id}}" p-type-igv="{{ $p->type_igv_id }}" codebar="{{ $p->code }}" p-price="{{$p->price}}" >{{$p->description}}</option>
                                                                    @endforeach
                                                                @endif
                                                            </select>
                                                            <div class="input-group-append">
            ...
            if (e.isDefaultPrevented()) {
                ...
                if (error === false) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if(response == true) {
                                toastr.success('Se grabó satisfactoriamente el Recibo por Honorario');
