                    ...
                    <form id="frm_shopping" method="post" class="form-horizontal" role="form" data-toggle="validator">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="moneda" id="moneda" required>
                                        @foreach($coin as $dt)
                                            @if($dt->id == 1 || $dt->id == 2)
                                                <option value="{{$dt->id}}" {{ $shopping->coin_id  == $dt->id ? 'selected' : '' }}>{{$dt->symbol}} {{$dt->description}}</option>
                                            @endif()
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="exchange_rate" id="exchange_rate" value="{{ $shopping->exchange_rate }}" >
                                </div>
                            </div>
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="tipvou" id="tipdoc" required="">
                                        ...
                                        <option value="1" {{ $shopping->type_vouchers_id  == '1' ? 'selected' : '' }} data-code="01">FACTURA</option>
                                        <option value="2" {{ $shopping->type_vouchers_id  == '2' ? 'selected' : '' }} data-code="03">BOLETA DE VENTA</option>
                                        <option value="3" {{ $shopping->type_vouchers_id  == '3' ? 'selected' : '' }}>NOTA DE CRÉDITO DE BOLETA</option>
                                        <option value="4" {{ $shopping->type_vouchers_id  == '4' ? 'selected' : '' }}>NOTA DE CRÉDITO DE FACTURA</option>
                                        <option value="5" {{ $shopping->type_vouchers_id  == '5' ? 'selected' : '' }}>NOTA DE DÉBITO DE BOLETA</option>
                                        <option value="6" {{ $shopping->type_vouchers_id  == '6' ? 'selected' : '' }}>NOTA DE DÉBITO DE FACTURA</option>
                                        <option value="8" {{ $shopping->type_vouchers_id  == '8' ? 'selected' : '' }}>TICKET DE MAQUINA REGISTRADORA</option>
                                        <option value="17" {{ $shopping->type_vouchers_id  == '17' ? 'selected' : '' }}>COMPROBANTE DE PERCEPCIÓN</option>
                                        <option value="26" {{ $shopping->type_vouchers_id  == '26' ? 'selected' : '' }}>RECIBO DE SERVICIOS</option>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    <label>Serie</label>
                                    <input type="text" maxlength="5" name="shoppingSerie" id="shoppingSerie" class="form-control" value="{{ $shopping->shopping_serie }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    <label>Número</label>
                                    <input type="number" step="1" name="shoppingCorrelative" id="shoppingCorrelative" class="form-control" value="{{ $shopping->shopping_correlative }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="condition" id="condition" class="form-control">
                                        <option value="EFECTIVO" data-days="0" {{ $shopping->payment_type == 'EFECTIVO' ? 'selected' : '' }}>EFECTIVO</option>
                                        <option value="DEPOSITO EN CUENTA" data-days="0" {{ $shopping->payment_type == 'DEPOSITO EN CUENTA' ? 'selected' : '' }}>DEPOSITO EN CUENTA</option>
                                        <option value="CREDITO" data-days="7" {{ $shopping->payment_type == 'CREDITO' ? 'selected' : '' }}>CREDITO</option>
                                        <option value="TARJETA DE CREDITO" data-days="0" {{ $shopping->payment_type == 'TARJETA DE CREDITO' ? 'selected' : '' }}>TARJETA DE CREDITO</option>
                                        <option value="TARJETA DE DEBITO" data-days="0" {{ $shopping->payment_type == 'TARJETA DE DEBITO' ? 'selected' : '' }}>TARJETA DE DEBITO</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="mp" id="methodOption" class="form-control">
                                        @foreach ($paymentMethods as $paymentMethod)
                                            <option value="{{ $paymentMethod->id }}" {{ $shopping->payment_method_id ==  $paymentMethod->id ? 'selected' : '' }}>{{ $paymentMethod->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="tax_base" id="tax_base" class="form-control">
                                        <option value="006" {{ $shopping->tax_base == '006' ? 'selected' : '' }} selected="selected">OPER. GRAVADAS</option>
                                        <option value="007" {{ $shopping->tax_base == '007' ? 'selected' : '' }}>OPER. GRAV. Y NO GRAVA.</option>
                                        <option value="008" {{ $shopping->tax_base == '008' ? 'selected' : '' }}>OPER. NOGRAVADAS</option>
                                        <option value="999" {{ $shopping->tax_base == '999' ? 'selected' : '' }}>EXONERADAS</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12 col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="igv_percentage" id="igv_percentage" class="form-control">
                                        <option value="10" {{ $shopping->igv_percentage == '10.00' ? 'selected' : '' }}>10.00%</option>
                                        <option value="18" {{ $shopping->igv_percentage == '18.00' ? 'selected' : '' }}>18.00%</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-8">
                                ...
                                <textarea name="observations" id="observations" class="form-control">{{ $shopping->observations }}</textarea>
                            </div>
            ...
            if (e.isDefaultPrevented()) {
                ...
                if (error === false) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if(response == true) {
                                toastr.success('Se actualizó satisfactoriamente la Compra');
                                window.location.href = '{{route('logistic.purchases')}}';
                            }
                            else if(response == -1){
