        ...
        <div class="col-12">
            <div class="card card-default text-center">
                <div class="card-header color-gray">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="card-title">NOTAS DEBITO</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
    ...
    <script>
        let tbl_data = $("#tbl_data").DataTable({
            ...
            'fnRowCallback': function( nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                ...
                button += '<li><a href="#" class="consultCdr" style="color: #ea1024;">Enviar a la Sunat</a></li>';
        ...
        $('#tbl_data2').on('click', '.sendSunat', function() {
                ...
                buttons: {
                    Confirmar: {
                        ...
                        action: function() {
                            $.ajax({
                                type: 'post',
                                url: '/commercial/note/send/sunat/' + data['id'] + '/2' + '/0',
                                data: {
                                    _token: '{{csrf_token()}}'
                                },
                                dataType: 'json',
