                ...
                <div class="card-header color-gray">
                    <div class="row">
                        <div class="col-12 col-md-12">
                            <h3 style="color: white;" class="card-title">PERCEPCIONES</h3>
                        </div>
                    </div>
                    <div class="row">
...
@section('script_admin')
    <script>
        ...
        $('#btnCreate').click(function() {
            window.location.href = '/perception/create';
        });

        $('body').on('click', '.pdf', function() {
            let data = tbl_data.row( $(this).parents('tr') ).data();
            $('#frame_pdf').attr('src', '/perception/pdf/' + data['id']);
        ...
        $('#tbl_data').on('click', '.xml', function() {
            ...
            file += 40 + '-' + data['serial_number'] + '-' + data['correlative'];
        ...
        $('#tbl_data').on('click', '.cdr', function() {
            ...
            file += 40 + '-' + data['serial_number'] + '-' + data['correlative']  + '.zip';
            window.open(file, '_blank');
        });
                ...
                buttons: {
                    Confirmar: {
                        ...
                        action: function() {
                            $.ajax({
                                type: 'post',
                                url: '/perception/send/sunat/' + data['id'],
                                data: {
                                    _token: '{{csrf_token()}}'
                                },
                                dataType: 'json',
