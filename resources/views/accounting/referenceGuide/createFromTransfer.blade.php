                                        ...
                                        @foreach ($transfers as $t)
                                            <tr>    
                                                <td>
                                                    ...
                                                    <input type="hidden" name="cd_product[]" value="{{ $t->product_id }}">
                                                </td>
                                                <td>
                                                    {{ $t->quantity }}
                                                    <input type="hidden" name="cd_quantity[]" value="{{ $t->quantity }}">
                                                </td>
                                                <td>
                                ...
                                $.confirm({
                                    ...
                                    content: function () {
                                        ...
                                        return $.ajax({
                                            ...
                                            success: function(response) {
                                                if(response == true) {
                                                    // toastr.success('Se Creo correctamente la guia de remision');
                                                } else {
                                                    console.log(response.responseText);
toastr.error('Ocurrio un error');
                                                }
