...
@section('css')
    <style>
        ...
        .table-success-custom, .table-success-custom > th, .table-success-custom > td{background: #A3C318}
        .table-gray-custom, .table-gray-custom > th, .table-gray-custom > td{background: #838383; color: #fff;}
    </style>
@endsection
@section('content')
    <div class="row">
                ...
                <div class="card-header color-gray">
                    <div class="row">
                        <div class="col-12 text-center">
                            <h3 class="card-title">INVENTARIO REAL</h3>
                        </div>
                    </div>
                </div>
        ...
        let tbl_data = $("#tbl_data").DataTable({
            ...
            'fnRowCallback': function( nRow, aData, iDisplayIndex, iDisplayIndexFull) {
                if(aData['stock'] < aData['minimum_stock']) {
                    ...
                    $(nRow).addClass('table-gray');
                } else if(aData['stock'] > aData['minimum_stock']) {
                    $(nRow).addClass('table-success');
                }

                if (aData['product']['category_id'] == null) {
                    $(nRow).find('td:eq(5)').html('SIN CATEGORIA');
                } else {
                    $(nRow).find('td:eq(5)').html(aData['product']['category']['description']);
                }
            }
        });
